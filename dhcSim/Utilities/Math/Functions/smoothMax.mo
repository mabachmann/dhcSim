within dhcSim.Utilities.Math.Functions;
function smoothMax
...
algorithm
  y := dhcSim.Utilities.Math.Functions.regStep(
    y1=x1,
    y2=x2,
    x=x1 - x2,
    x_small=deltaX);
...
<a href=\"modelica://dhcSim.Utilities.Math.Examples.SmoothMin\">
dhcSim.Utilities.Math.Examples.SmoothMin</a>.
</p>
</html>",
revisions="<html>
<ul>
