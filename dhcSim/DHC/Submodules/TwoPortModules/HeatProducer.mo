...
equation
  ...
  connect(heaCoo.Q_flow, add.u1) annotation (Line(points={{-19,-8},{20,-8},{20,-64},
          {58,-64}}, color={0,0,127}));
  connect(heaCoo.Q_flow, Q_flow_out) annotation (Line(points={{-19,-8},{-19,-8},
          {20,-8},{20,-50},{110,-50}}, color={0,0,127}));
