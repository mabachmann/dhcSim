...
package Types "Package with type definitions"
  ...
  type OutletTemperature = enumeration(
      port_b
           "port_b",
      average
            "(port_a+port_b)/2",
  ...
  type FeedingTemperatureCon = enumeration(
      fixed
          "Fixed temperature",
      dTFix
      ...
      m_flow_const
                 "Constant mass flow",
      heatExchanger
                  "HeatExchanger") "Enumeration to define the feeding temperature of consumers";

  type FeedingTemperaturePro = enumeration(
      fixed
          "Fixed temperature",
      dTFix
          "Fixed temperature difference") "Enumeration to define the feeding temperature of producers";
...
Note that for a given heat exchanger, the
 ...
 <a href=\"modelica://dhcSim.Fluid.Types.HeatExchangerFlowRegime\">
 dhcSim.Fluid.Types.HeatExchangerFlowRegime</a> may change. For example,
 a counter flow heat exchanger has <code>HeatExchangerConfiguration=CounterFlow</code>,
 but the <a href=\"modelica://dhcSim.Fluid.Types.HeatExchangerFlowRegime\">
 dhcSim.Fluid.Types.HeatExchangerFlowRegime</a> can change to parallel flow if one of the two capacity flow rates reverts
 its direction.
 </p>
</html>", revisions=
          "<html>
